      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        <div className={`backdrop-blur-xl ${t.card} border rounded-3xl shadow-2xl p-8 transition-colors duration-300`}>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button
              type="button"
              className="bg-white text-black rounded-xl py-3 font-medium flex items-center justify-center gap-2 hover:scale-[1.02] transition-all duration-300 shadow-sm"
            >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-linear-to-r from-purple-600 to-blue-600 hover:opacity-90 text-white font-semibold py-3 rounded-xl transition-all duration-300 hover:scale-[1.01] shadow-lg shadow-purple-500/20 flex items-center justify-center gap-2"
            >
              Sign In
